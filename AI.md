...
| ✅ 學習準度 | 70 ~ 95       | 很適合作為 **窗口** 查找必要功能與資訊，但程式學習面尚待穩定 |
| ⭕️ 模糊前四 | 60 ~ 80       | 如初始論述有較多模糊邏輯，可重複收斂問題，前四次大致上都能得到滿意的答案 |
| ❌ 模糊超四 | **-100** ~ 60 | 如超過四次則高機率出現錯誤雜亂資訊，也就是**幻覺**，需盡量避免模糊邏輯 |
| ⭕️ 程式建構 | 59 ~ 95       | 大致表現不錯，但深挖技術面還是不少錯誤或虛假訊息，因此自身還是要有豐富且正確的辨別能力 |
| ✅ 程式優化 | 80 ~ 95       | 給予最高好評，甚至可以學習到未曾學過的資料結構與效能技巧，但還是要有豐富且正確的辨別能力 |
| ❌ 框架整體 | 39 ~ 70       | 目前框架面還是人類較強，建議自身還是要掌握正確資料結構與資料流的技能，配合 AI 漸進優化 |