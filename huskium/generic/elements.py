...
class Elements[WD: WebDriver, WE: WebElement]:
    ...
    def _verify_by(self, by: Any) -> None:
        ...
        """
        raise NotImplementedError('"_verify_by" must be implemented in selenium or appium Elements.')
    ...
    def _verify_set_value(self, value: Any) -> None:
        ...
        This must be implemented in selenium or appium Elements.
        """
        raise NotImplementedError('"_verify_set" must be implemented in selenium or appium Elements.')
    ...
    def wait_all_present(
        ...
        try:
            return self.waiting(timeout).until(
                ECEX[WD, WE].presence_of_all_elements_located(self.locator)
            )
    ...
    def wait_all_absent(
        ...
        try:
            return self.waiting(timeout).until(
                ECEX[WD, WE].absence_of_all_elements_located(self.locator)
            )
        except TimeoutException as exc:
    ...
    def wait_all_visible(
        ...
        try:
            return self.waiting(timeout, StaleElementReferenceException).until(
                ECEX[WD, WE].visibility_of_all_elements_located(self.locator)
            )
        except TimeoutException as exc:
    ...
    def wait_any_visible(
        ...
        try:
            return self.waiting(timeout, StaleElementReferenceException).until(
                ECEX[WD, WE].visibility_of_any_elements_located(self.locator)
            )
        except TimeoutException as exc:
