...
class Element[WD: WebDriver, WE: WebElement]:
    ...
    def __set__(self, instance: Page[WD, WE], value: Element) -> None:
    ...
    def _verify_by(self, by: Any) -> None:
        ...
        """
        raise NotImplementedError('"_verify_by" must be implemented in selenium or appium Element.')
    ...
    def _verify_set(self, value: Any) -> None:
        ...
        This must be implemented in selenium or appium Element.
        """
        raise NotImplementedError('"_verify_set" must be implemented in selenium or appium Element.')
    ...
    def wait_present(
        ...
        try:
            element = self.waiting(timeout).until(
                ECEX[WD, WE].presence_of_element_located(self.locator, self.index)
            )
    ...
    def wait_absent(
        ...
        try:
            return self.waiting(timeout).until(
                ECEX[WD, WE].absence_of_element_located(self.locator, self.index)
            )
        except TimeoutException as exc:
        ...
        try:
            try:
                self._visible_cache = self.waiting(timeout).until(
                    ECEX[WD, WE].visibility_of_element(self.present_caching)
                )
                return self._visible_cache
            except ELEMENT_REFERENCE_EXCEPTIONS:
                element = self.waiting(timeout, StaleElementReferenceException).until(
                    ECEX[WD, WE].visibility_of_element_located(self.locator, self.index)
                )
            ...
            try:
                return cast(
                    ...
                    self.waiting(timeout).until(
                        ECEX[WD, WE].invisibility_of_element(self.present_caching, present)
                    )
                )
            except ELEMENT_REFERENCE_EXCEPTIONS:
                element_or_true = self.waiting(timeout, StaleElementReferenceException).until(
                    ECEX[WD, WE].invisibility_of_element_located(self.locator, self.index, present)
                )
        ...
        try:
            try:
                self._clickable_cache = self._visible_cache = self.waiting(timeout).until(
                    ECEX[WD, WE].element_to_be_clickable(self.present_caching)
                )
                return self._clickable_cache
            except ELEMENT_REFERENCE_EXCEPTIONS:
                element = self.waiting(timeout, StaleElementReferenceException).until(
                    ECEX[WD, WE].element_located_to_be_clickable(self.locator, self.index)
                )
        ...
        try:
            try:
                return cast(
                    WE | Literal[True],
                    self.waiting(timeout).until(
                        ECEX[WD, WE].element_to_be_unclickable(self.present_caching, present)
                    )
                )
            except ELEMENT_REFERENCE_EXCEPTIONS:
                element_or_true = self.waiting(timeout, StaleElementReferenceException).until(
                    ECEX[WD, WE].element_located_to_be_unclickable(self.locator, self.index, present)
                )
                self._cache_present_element(element_or_true)
                return cast(WE | Literal[True], element_or_true)
        except TimeoutException as exc:
    ...
    def wait_selected(
        ...
        try:
            try:
                return self.waiting(timeout).until(
                    ECEX[WD, WE].element_to_be_selected(self.present_caching)
                )
            except ELEMENT_REFERENCE_EXCEPTIONS:
                element = self.waiting(timeout, StaleElementReferenceException).until(
                    ECEX[WD, WE].element_located_to_be_selected(self.locator, self.index)
                )
                self._cache_present_element(element)
                return element
        except TimeoutException as exc:
    ...
    def wait_unselected(
        ...
        try:
            try:
                return self.waiting(timeout).until(
                    ECEX[WD, WE].element_to_be_unselected(self.present_caching)
                )
            except ELEMENT_REFERENCE_EXCEPTIONS:
                element = self.waiting(timeout, StaleElementReferenceException).until(
                    ECEX[WD, WE].element_located_to_be_unselected(self.locator, self.index)
                )
                self._cache_present_element(element)
                return element
        except TimeoutException as exc:
